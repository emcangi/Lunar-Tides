...
result_file = 'timegcm_results_SLT_{}.txt'             # Stores results
...
plt.title('SW2 tidal amplitude (zonal wind speeds)', y=1.05)
...
plt.rc('xtick', labelsize=8)
plt.rc('ytick', labelsize=12)
plt.title('SW2 tidal phases (zonal wind speeds)', y=1.05)
