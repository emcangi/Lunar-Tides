...
bin_sz = 0.5                    # Bin size to use when doing SLT and LLT
# binning
...
f1 = 'genM2_dt={}_b{}_sc1.txt'    # File to write generated tidal data
f2 = 'reconM2_dt={}_b{}_sc1.txt'  # File to write reconstructed lunar tidal data
...
# average by LLT)
t = 'Original and reconstructed M2, full lunar cycle, bin={} min, sc1'.format(
    int(bin_sz * 60))
