...
ends = ['2016-01-15',                 # End date for data generation
        '2016-01-23',
        '2016-01-30']
f1 = 'genM2_{}_dt={}_b{}_sc4.txt'     # File to write generated tidal data
f2 = 'reconM2_{}_dt={}_b{}_sc4.txt'   # File to write reconstructed tidal data
f3 = 'origM2_{}_dt={}_b{}_sc4.txt'    # File to write original M2 data after binsz
f4 = 'scenario4_results.txt'          # Prints results of χ² test, etc
...
f.write('Solar amplitude: {}'.format(a[1]))
f.write('Solar phase: 1 (maximum; actual tide varies sinusoidally)\n')
f.write('Lunar amplitude: {} (maximum; actual tide varies '
        'sinusoidally)\n'.format(a[2]))
f.write('Lunar phase: 1 (maximum; actual tide varies sinusoidally)\n')
f.write('\n')
f.close()
